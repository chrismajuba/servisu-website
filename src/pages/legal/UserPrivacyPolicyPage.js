    ...
    <div className="legal-page">
      <div className="legal-container">
        <div className="legal-header">
          <h1>Privacy Policy - For Users</h1>
        </div>
        ...
        <div className="legal-content">
          <section className="legal-section">
            ...
            <ul>
              ...
              <li>
                ...
                details when you book services or use location-based features
              </li>
              <li>
                <strong>Service Preferences:</strong> Information about the
                services you request and your booking history
              </li>
              <li>
          ...
          <section className="legal-section">
            ...
            <ul>
              ...
              <li>
                Use your address and location data to match you with nearby service
                providers and ensure accurate service delivery
              </li>
          ...
          <section className="legal-section">
            ...
            <ul>
              <li>
                <strong>Service Providers:</strong> We may share your contact
                information, address, and location data with service providers who
                will fulfill your bookings. This information is shared only to the
                extent necessary to complete the requested service.
              </li>
              <li>
